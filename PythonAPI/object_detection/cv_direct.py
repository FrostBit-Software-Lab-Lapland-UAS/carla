...
def detect(opt):
    ...
    img = cv2.imread('C:/Users/anarkila/Desktop/yolov5/yolov5_deepsort/Yolov5_DeepSort_Pytorch/test.jpg')
    ...
    # else:
    #     dataset = LoadImages(source, img0=img, img_size=imgsz, stride=stride)
        #print(dataset)


    dataset = DirectDataset(img0=img, img_size=imgsz, stride=stride)
