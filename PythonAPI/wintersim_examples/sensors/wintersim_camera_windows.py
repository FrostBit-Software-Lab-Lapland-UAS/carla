...
class CameraWindows(threading.Thread):
    ...
    def camera_blueprint(self, camera_effect):
        """Returns RGB camera blueprint."""
        camera_bp = self.world.get_blueprint_library().find('sensor.camera.rgb')
        camera_bp.set_attribute('image_size_x', str(VIEW_WIDTH))
        camera_bp.set_attribute('image_size_y', str(VIEW_HEIGHT))
        camera_bp.set_attribute('fov', str(VIEW_FOV))
        camera_bp.set_attribute('camera_sleet_effect', str(camera_effect)) # WinterSim added attribute! Values: True / False
    ...
    def setup_front_rgb_camera(self):
        ...
        self.front_rgb_camera = self.world.spawn_actor(self.camera_blueprint(True), camera_transform, attach_to=self.car)
    ...
    def setup_back_rgb_camera(self):
        ...
        self.back_rgb_camera = self.world.spawn_actor(self.camera_blueprint(False), camera_transform, attach_to=self.car)
